    ...
    <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
        <div>
          ...
          <input type="text" name="contactPerson" placeholder="e.g. Jane Smith" className="input-field" />
        </div>
        <div>
          <label style={{ display: "block", marginBottom: "0.25rem", fontSize: "0.85rem", color: "#475569", fontWeight: "500" }}>Phone Number</label>
          <input type="text" name="phone" placeholder="e.g. +1 987 654 321" className="input-field" />
        </div>
      </div>
      
      <div>
        <label style={{ display: "block", marginBottom: "0.25rem", fontSize: "0.85rem", color: "#475569", fontWeight: "500" }}>Email Address</label>
        <input type="email" name="email" placeholder="e.g. jane@globex.com" className="input-field" />
      </div>
      
      <div>
        <label style={{ display: "block", marginBottom: "0.25rem", fontSize: "0.85rem", color: "#475569", fontWeight: "500" }}>Specialties / Services Provided</label>
